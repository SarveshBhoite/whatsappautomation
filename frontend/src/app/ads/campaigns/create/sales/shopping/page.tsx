...
export default function SalesShoppingPage() {
  ...
  // Campaign Name
  const [campaignName, setCampaignName] = useState<string>("Sales-Shopping-1");
    ...
    fetch(`${BACKEND}/api/ads/campaigns?orgId=${encodeURIComponent(orgId)}&customerId=${encodeURIComponent(targetCid)}`)
      ...
      .then(data => {
        if (Array.isArray(data)) {
          ...
          while (existingLower.includes(`sales-shopping-${nextIndex}`.toLowerCase())) {
            nextIndex++;
          }
          const defaultName = `Sales-Shopping-${nextIndex}`;
              ...
              <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-y-4 text-xs">
                  ...
                  <div>
                    ...
                    <p className="text-slate-800 font-semibold mt-1">Sales</p>
                  </div>
                  <div>
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    const res = await fetch(`${BACKEND}/api/ads/campaigns/sales/shopping`, {
                      method: "POST",
