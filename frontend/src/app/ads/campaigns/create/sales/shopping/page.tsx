...
export default function SalesShoppingPage() {
  ...
  const availableGoalsList = [
    ...
    { id: "purchases", name: "Purchases (account default)", source: "Website", count: "3 actions" }
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans">
      ...
      <main className="flex-1 p-6 md:p-10 overflow-y-auto space-y-6 max-w-4xl mx-auto pb-24">
        ...
        {/* Header Title */}
        <div>
          <h1 className="text-2xl font-semibold text-white tracking-tight">Shopping Campaign Setup</h1>
          <p className="text-xs text-slate-400 mt-1">Promote your products from Google Merchant Center with Shopping ads</p>
        </div>
        ...
        <div className="p-6 rounded-2xl border border-slate-800 bg-slate-900/90 space-y-4 shadow-xl">
          <div className="flex items-center gap-3 border-b border-slate-800 pb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Connect Google Merchant Center to serve Shopping ads</p>
            </div>
          </div>
            ...
            try {
              ...
              await fetch(`${BACKEND}/api/ads/campaign/launch`, {
                ...
                body: JSON.stringify({
                  ...
                  campaignName: campaignName || "Sales-Shopping-1",
              ...
              alert(`Shopping campaign "${campaignName}" published successfully!`);
