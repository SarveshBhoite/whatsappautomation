      ...
      <header className="h-14 bg-white border-b border-slate-200 px-6 flex items-center justify-between shrink-0 sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 border-l border-slate-200 pl-4 text-xs font-semibold">
            <span className="text-slate-500">NoGuidance</span>
              ...
              <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-y-4 text-xs">
                  <div>
                    ...
                    <p className="text-slate-800 font-semibold mt-1">NoGuidance-Shopping-1</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-800 font-semibold mt-1">Downloads, Phone call leads</p>
                  </div>
                  <div>
              ...
              try {
                ...
                await fetch(`${BACKEND}/api/ads/campaigns/no-guidance/shopping`, {
                  ...
                  body: JSON.stringify({
                    ...
                    campaignName: "NoGuidance-Shopping-1",
