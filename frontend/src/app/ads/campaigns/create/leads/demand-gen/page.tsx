      ...
      <header className="h-14 bg-slate-900 border-b border-slate-800 px-6 flex items-center justify-between shrink-0 sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 border-l border-slate-800 pl-4">
            ...
            <span className="text-sm font-semibold text-slate-200">Leads • Demand Gen</span>
          </div>
        </div>
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <div className="relative w-48">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-900 border border-rose-500/50 rounded-xl pl-8 pr-4 py-2 text-xs text-slate-100 focus:outline-none focus:border-rose-500"
                      />
                    </div>
                  </div>
