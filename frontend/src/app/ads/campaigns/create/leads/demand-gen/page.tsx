...
export default function LeadsDemandGenPage() {
  ...
  const existingCampaigns = [
    ...
    { id: "c-102", name: "Leads Summer Promo - Video", type: "Video", status: "Ended", budget: "₹2,000/day" },
    { id: "c-103", name: "Demand Gen - High Intent Audiences", type: "Demand Gen", status: "Active", budget: "₹3,500/day" },
    { id: "c-104", name: "Leads - Discovery 2026", type: "Display", status: "Paused", budget: "₹1,000/day" },
      ...
      <header className="h-14 bg-white border-b border-slate-200 px-6 flex items-center justify-between shrink-0 sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 border-l border-slate-200 pl-4">
            ...
            <span className="text-sm font-semibold text-slate-800">Leads • Demand Gen</span>
          </div>
        </div>
          ...
          {demandGenStep === "AD_GROUP" ? (
            ...
            <div className="space-y-6 animate-in fade-in duration-200">
              ...
              <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-lg">
                ...
                <p className="text-xs text-slate-500">Choose which ad channels your ad group is eligible to serve on</p>
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <div className="relative w-48">
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-rose-500/50 rounded-xl pl-8 pr-4 py-2 text-xs text-slate-900 focus:outline-none focus:border-rose-500"
                      />
                    </div>
                  </div>
      ...
      <footer className="fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-slate-200 px-8 flex items-center justify-between z-50">
        ...
        <div className="flex items-center gap-3">
          ...
          {demandGenStep === "REVIEW" && (
            <button
              onClick={() => {
                alert(`Leads Demand Gen campaign "${demandGenCampaignName}" published successfully!`);
