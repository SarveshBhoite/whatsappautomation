...
export default function WebsiteTrafficDisplayPage() {
  ...
  const [displayCampaignName, setDisplayCampaignName] = useState<string>(`WebsiteTraffic-Display-${Date.now().toString().slice(-4)}`);
                ...
                <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-sm">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center justify-between p-3 rounded-xl border border-slate-200 bg-slate-50">
                      ...
                      <span className="font-semibold text-slate-800">WebsiteTraffic</span>
                    </div>
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  const payloadToLaunch = {
                    ...
                    campaignName: displayCampaignName.trim() || `WebsiteTraffic-Display-${Date.now()}`,
                    channelType: "DISPLAY",
                    ...
                    finalUrl: finalUrl.trim() || "https://www.WebsiteTraffic-automation.com",
                    businessName: businessName.trim() || "WebsiteTraffic",
