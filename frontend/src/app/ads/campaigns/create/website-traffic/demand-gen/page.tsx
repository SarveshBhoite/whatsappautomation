...
export default function WebsiteTrafficDemandGenPage() {
  ...
  const existingCampaigns = [
    ...
    { id: "c-102", name: "Website Traffic Summer Promo - Video", type: "Video", status: "Ended", budget: "₹2,000/day" },
      ...
      <header className="h-14 bg-white border-b border-slate-200 px-6 flex items-center justify-between shrink-0 sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 border-l border-slate-200 pl-4">
            ...
            <span className="text-sm font-semibold text-slate-800">Website Traffic • Demand Gen</span>
          </div>
        </div>
      ...
      <footer className="fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-slate-200 px-8 flex items-center justify-between z-50">
        ...
        <div className="flex items-center gap-3">
          ...
          {demandGenStep === "REVIEW" && (
            <button
              onClick={() => {
                alert(`Website Traffic Demand Gen campaign "${demandGenCampaignName}" published successfully!`);
