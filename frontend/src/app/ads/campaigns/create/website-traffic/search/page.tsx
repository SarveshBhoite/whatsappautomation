          ...
          {wizardStep === "KEYWORDS_ADS" && (
            <div className="space-y-6 animate-in fade-in duration-200 text-xs">
              ...
              <div className="space-y-1 pt-4">
                <h2 className="text-base font-bold text-slate-100">Create ads to get more website traffic</h2>
              </div>
                    ...
                    <div className="p-4 rounded-xl border border-slate-800 bg-slate-950 space-y-3">
                      <div className="flex items-center justify-between border-b border-slate-800 pb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-slate-400 text-[11px] font-mono">{headlines.filter(h => h).length} / 15</span>
                          <HelpCircle className="h-3.5 w-3.5 text-slate-500 cursor-pointer" />
                        </div>
                        <div className="flex items-center gap-3">
                    ...
                    <div className="p-4 rounded-xl border border-slate-800 bg-slate-950 space-y-3">
                      <div className="flex items-center justify-between border-b border-slate-800 pb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-slate-400 text-[11px] font-mono">{descriptions.filter(d => d).length} / 4</span>
                          <HelpCircle className="h-3.5 w-3.5 text-slate-500 cursor-pointer" />
                        </div>
                        <div className="flex items-center gap-3">
                          <button type="button" className="text-blue-400 text-[11px] font-semibold hover:underline">View ideas</button>
              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-900/90 overflow-hidden divide-y divide-slate-800">
                  ...
                  <div className="p-4 flex items-center justify-between">
                    ...
                    <span className="flex-1 text-slate-100 font-semibold">Website Traffic</span>
                  </div>
                  <div className="p-4 flex items-center justify-between">
