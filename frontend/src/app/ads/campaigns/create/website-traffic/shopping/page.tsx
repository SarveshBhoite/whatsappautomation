...
export default function WebsiteTrafficShoppingPage() {
      ...
      <header className="h-14 bg-white border-b border-slate-200 px-6 flex items-center justify-between shrink-0 sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 border-l border-slate-200 pl-4 text-xs font-semibold">
            <span className="text-slate-500">WebsiteTraffic</span>
              ...
              {openBudgetSetting === "budget" ? (
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    <div className="pt-2 max-w-md relative">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-8 pr-4 py-3 text-sm text-slate-900 font-medium focus:outline-none focus:border-primary transition-all"
                ...
                <div className="p-4 rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-between cursor-pointer hover:bg-slate-100 transition-colors" onClick={() => setOpenBudgetSetting("budget")}>
                  <div className="flex items-center gap-16">
                    ...
                    <span className="text-xs text-slate-500">{budgetAmount ? `₹${budgetAmount}/${budgetType === "daily" ? "day" : "total"}` : "Not set"}</span>
                  </div>
                    ...
                    {bidStrategy === "Target ROAS" && (
                      <div className="pt-2 max-w-md relative">
                        <input
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-900 font-medium focus:outline-none focus:border-primary transition-all"
                          placeholder="%"
                        />
                ...
                <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-sm">
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    {locationType === "Another" && (
                      <input type="text" value={customLocation} onChange={(e) => setCustomLocation(e.target.value)} placeholder="Enter a location to target" className="w-full max-w-md bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm text-slate-900 font-medium focus:outline-none focus:border-primary mt-2" />
                    )}
                ...
                <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                    <div className="space-y-2">
                      ...
                      <input type="date" value={startDate} onChange={(e) => setStartDate(e.target.value)} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-900 font-mono focus:outline-none focus:border-primary" />
                    </div>
                    <div className="space-y-2">
                      ...
                      {endDateOption === "Select a date" && (
                        <input type="date" value={endDate} onChange={(e) => setEndDate(e.target.value)} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-900 font-mono focus:outline-none focus:border-primary" />
                      )}
                    </div>
                  </div>
            ...
            <div className="space-y-6 animate-in fade-in duration-200">
              ...
              {openAdGroupSetting === "ad_group" ? (
                <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-sm">
                  ...
                  <div className="space-y-4 pt-2">
                    <div className="space-y-1">
                      <label className="block text-slate-700 font-semibold text-xs">Ad group name</label>
                      <input type="text" value={adGroupName} onChange={e => setAdGroupName(e.target.value)} className="w-full max-w-md bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-900 font-medium focus:outline-none focus:border-primary" />
                    </div>
                    <div className="space-y-1">
                      <label className="block text-slate-700 font-semibold text-xs">Ad group bid</label>
                      <p className="text-[11px] text-slate-500 mb-2">Enter your cost-per-click (CPC) bid</p>
                      <div className="relative max-w-xs">
                        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 font-mono">₹</span>
                        <input type="number" value={adGroupBid} onChange={e => setAdGroupBid(e.target.value)} placeholder="Enter an amount" className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-8 pr-4 py-2.5 text-sm text-slate-900 font-medium focus:outline-none focus:border-primary" />
                      </div>
                    </div>
                  </div>
                  <div className="pt-4 border-t border-slate-200 flex justify-end">
                ...
                <div className="p-4 rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-between cursor-pointer hover:bg-slate-100 transition-colors" onClick={() => setOpenAdGroupSetting("ad_group")}>
                  <div className="flex items-center gap-16">
                    ...
                    <span className="text-xs text-slate-500">{adGroupName} • Bid: {adGroupBid ? `₹${adGroupBid}` : "Not set"}</span>
                  </div>
                  <Edit3 className="h-4 w-4 text-slate-500" />
                </div>
              )}
              ...
              {openAdGroupSetting === "product_groups" ? (
                <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-sm">
                  ...
                  <div className="space-y-4 pt-2 text-xs">
                    ...
                    <p className="text-slate-500">Choose which products to show in your ads. Some of your ads will use images, headlines and descriptions from Merchant Center.</p>
              ...
              {openAdGroupSetting === "assets" ? (
                <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-sm">
                  ...
                  <div className="space-y-4 pt-2">
                    <p className="text-xs text-slate-500">Ads will be created using your product data from Merchant Center. Adding assets can help improve your ad quality.</p>
                ...
                <div className="p-4 rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-between cursor-pointer hover:bg-slate-100 transition-colors" onClick={() => setOpenAdGroupSetting("assets")}>
                  <div className="flex items-center gap-16">
                    <h2 className="text-sm font-semibold text-slate-800 w-48">Business logo</h2>
                    <span className="text-xs text-slate-500">{uploadedLogo ? "1 logo added" : "No logo added"}</span>
                  </div>
                  <Edit3 className="h-4 w-4 text-slate-500" />
                </div>
              )}
              ...
              <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-y-4 text-xs">
                  <div>
                    ...
                    <p className="text-slate-800 font-semibold mt-1">WebsiteTraffic-Shopping-1</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-800 font-semibold mt-1">Downloads, Phone call WebsiteTraffic</p>
                  </div>
                  <div>
                    <p className="text-slate-500 font-medium">Merchant Center and CSS</p>
                    <p className="text-slate-800 font-semibold mt-1">5840531233 - jisnu digital solutions / CSS: Google Shopping (google.com/shopping)</p>
                  </div>
                  <div>
              ...
              <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-y-4 text-xs">
                  ...
                  <div>
                    ...
                    <p className="text-slate-800 font-semibold mt-1">{bidStrategy}</p>
                  </div>
                  <div>
              ...
              <div className="p-6 rounded-2xl border border-slate-200 bg-white space-y-4 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-y-4 text-xs">
                  <div>
                    ...
                    <p className="text-slate-800 font-semibold mt-1">{adGroupName}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-800 font-semibold mt-1">{productGroup}</p>
                  </div>
                  <div>
              ...
              try {
                ...
                await fetch(`${BACKEND}/api/ads/campaign/launch`, {
                  ...
                  body: JSON.stringify({
                    ...
                    campaignName: "WebsiteTraffic-Shopping-1",
