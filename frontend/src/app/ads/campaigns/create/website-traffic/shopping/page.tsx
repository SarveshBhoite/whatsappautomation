...
export default function WebsiteTrafficShoppingPage() {
  ...
  const [campaignName, setCampaignName] = useState<string>("Website traffic-Shopping-1");
  ...
  const availableGoalsList = [
    { id: "page_views", name: "Page views (account default)", source: "Website", count: "5 actions" },
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans">
      ...
      <main className="flex-1 p-6 md:p-10 overflow-y-auto space-y-6 max-w-4xl mx-auto pb-24">
        ...
        {/* Header Title */}
        <div>
          <h1 className="text-2xl font-semibold text-white tracking-tight">Website Traffic Shopping Campaign Setup</h1>
          <p className="text-xs text-slate-400 mt-1">Promote your products from Google Merchant Center to bring interested shoppers to your site</p>
        </div>
        ...
        <div className="p-6 rounded-2xl border border-slate-800 bg-slate-900/90 space-y-3 shadow-xl">
          ...
          <input
            ...
            placeholder="Website traffic-Shopping-1"
        ...
        <div className="p-6 rounded-2xl border border-slate-800 bg-slate-900/90 space-y-4 shadow-xl">
          <div className="flex items-start justify-between border-b border-slate-800 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">Conversion goals labeled as account default will use data from all of your campaigns to improve your bid strategy and site visit performance.</p>
            </div>
            <button
        ...
        <div className="p-6 rounded-2xl border border-slate-800 bg-slate-900/90 space-y-4 shadow-xl">
          <div className="flex items-center gap-3 border-b border-slate-800 pb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Connect Google Merchant Center to serve Shopping ads for website traffic</p>
            </div>
          </div>
            ...
            try {
              ...
              await fetch(`${BACKEND}/api/ads/campaign/launch`, {
                ...
                body: JSON.stringify({
                  ...
                  campaignName: campaignName || "Website traffic-Shopping-1",
                  channelType: "SHOPPING",
                  biddingStrategy: "MAXIMIZE_CONVERSIONS"
                })
              });
            } catch (err) {
              console.error("Save & Publish Website Traffic Shopping fallback:", err);
            } finally {
              setIsPublishing(false);
              alert(`Website traffic Shopping campaign "${campaignName}" published successfully!`);
