...
`;
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-slate-50 text-slate-900 font-sans">
      ...
      <div className="border-b border-slate-200 bg-slate-100/70 px-4 sm:px-6 py-2 flex items-center gap-2 overflow-x-auto no-scrollbar scrollbar-none shrink-0">
        <button
          onClick={() => setActiveTab("seo")}
          className={`px-3.5 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2 cursor-pointer whitespace-nowrap shrink-0 ${
            activeTab === "seo"
