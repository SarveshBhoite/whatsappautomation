  ...
  return (
    <div className="w-full max-w-7xl mx-auto bento-card bento-glow-border p-4 sm:p-8 bg-white/95 overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-6 border-b border-slate-100">
        <div>
          <span className="text-xs font-black uppercase tracking-widest text-brand-blue block mb-1">
        ...
        <span className="self-start sm:self-auto text-xs font-bold text-slate-600 bg-slate-100 px-3 py-1.5 rounded-xl border border-slate-200">
          All 12 Modules Included in Workspace
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pt-6">
        ...
        {/* Right Side: Deep Interactive Showcase Card of the Selected Module */}
        <div className="lg:col-span-6 flex flex-col justify-between p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-slate-50 to-white border border-slate-200 shadow-md">
          <div className="flex flex-col gap-4">
            {/* Badge & Icon header */}
            <div className="flex items-center justify-between">
              <div className={`w-12 h-12 rounded-2xl flex items-center justify-center border shadow-xs ${selectedModule.iconBg}`}>
                {selectedModule.icon}
              </div>
              <span className="text-xs font-extrabold px-3 py-1 rounded-full bg-slate-900 text-white shadow-xs">
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed bg-white p-4 rounded-xl border border-slate-200/90 shadow-2xs">
              {selectedModule.description}
            </p>

            <div className="p-3.5 rounded-xl bg-emerald-50/80 border border-emerald-200/80 flex items-center gap-2.5 text-xs font-bold text-emerald-900">
