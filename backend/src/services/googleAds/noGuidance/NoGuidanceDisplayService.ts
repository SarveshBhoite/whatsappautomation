    ...
    try {
      ...
      try {
        ...
        apiResult.adGroupResourceName = adGroupRef;
         ...
         console.warn("[Google Ads API fallback for No Guidance Display Ad Group]:", err.message);
      }
    } catch (apiErr: any) {
      console.warn("[Google Ads API fallback for No Guidance Display]:", apiErr.message);
    }
