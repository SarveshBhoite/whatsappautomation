    ...
    try {
      ...
      try {
        ...
        apiResult.adGroupResourceName = adGroupRef;
         ...
         console.warn("[Google Ads API fallback for Website Traffic Display Ad Group]:", err.message);
      }
    } catch (apiErr: any) {
      console.warn("[Google Ads API fallback for Website Traffic Display]:", apiErr.message);
    }
