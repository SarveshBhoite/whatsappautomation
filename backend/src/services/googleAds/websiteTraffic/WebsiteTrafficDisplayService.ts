    ...
    try {
      ...
      for (const img of rawImages) {
        ...
        if (fieldType === "MARKETING_IMAGE" || aspectRatio === "1.91:1") {
          ...
          // If already 1:1 square cropped, use directly or transform with 1:1 fo-auto
          ...
          // If fieldType is LOGO in images array, ensure it is converted/uploaded for logoImages
