...
export class MetaAdsResearchService {
  ...
  static analyzeAccount(context: MetaAdsContext): AccountPerformanceAudit {
    ...
    const recommendedStrategy: AccountPerformanceAudit["recommendedStrategy"] = {
      ...
      suggestedHeadline: `⚡ ${primaryPageName} Exclusive Offer | Limited Time Only!`,
      suggestedPrimaryText: `Looking for top-quality service in your area?\n\nConnect directly with ${primaryPageName} on WhatsApp for instant pricing, exclusive seasonal discounts, and priority consultation!\n\n✅ 100% Guaranteed Quality & Authenticity\n⚡ Instant WhatsApp Response in Under 5 Minutes\n🎁 Exclusive First-Time Inquiry Bonus\n⭐ Rated 4.9/5 by 1,800+ Delighted Customers\n\n👉 Tap 'Send WhatsApp Message' below to claim your spot today!`,
      suggestedDescription: `⭐ 4.9/5 Rating (1,800+ Happy Clients) • 100% Guaranteed Results • Fast Response`,
